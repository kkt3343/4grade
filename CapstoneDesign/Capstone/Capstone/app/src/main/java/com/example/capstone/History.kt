...
class History : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, saveInstanceState: Bundle?): View? {
        ...
        layout = inflater.inflate(R.layout.history, container, false)
    ...
    fun History_layout_make(context: Context, layout: View)
    {
        //history를 가져온다.
        ...
        //동적할당 부분
        //스크롤 뷰에 추가한다.
        scrolllayout = layout.findViewById(R.id.history_scroll) as LinearLayout
        for (i in 0 until getcount)
        {
            //레이아웃을 먼저 추가
...
//                var caridArray2 : ArrayList<Any> = getStringArrayPref(context, "history")
//                Log.d("aa", caridArray2.toString())
    ...
    override fun onResume() {
        ...
        box = getStringArrayPref(mycontext, "history")
        ...
        //뷰 구성
        History_layout_make(mycontext, layout)
    }
}