...
<body>
	<?php
		...
		$sql1 = "SELECT * from characters WHERE charactername LIKE '{$charactername}'";
		$ret1 = mysqli_query($con, $sql1);
		$row = mysqli_fetch_array($ret1);
		
		$old_img = "char_img/".strval($row['hair'])."x".strval($row['face']).".png";		
	?>
	...
	<table>
		<thead>
			<tr>
				<th colspan="4">캐릭터 수정</th>
				<th colspan="1">수정 전 나의 캐릭터</th>
				<th colspan="1">수정 후 나의 캐릭터</th>
			</tr>
		</thead>
		<tbody>
			<tr height="50">
				...
				<td rowspan="4"><div style="text-align: center;"><img id="charimg2" src="<?php echo $old_img?>"></img></div></td>
				<td rowspan="4"><div style="text-align: center;"><img id="charimg" src="char_img/0x0.png"></img></div></td>
			</tr>
			<tr height="50">
				<td>성형</td>
			...
			<tr height="50">
				<td>기존 이름</td>
				<td colspan="3"><?php echo $row['charactername']?></td>
			</tr>
			<tr height="50">
				<td>신규 이름</td>
			...
			<tr>
				<td colspan="3">
					<div style="text-align: center;"><button onClick="character_create()">캐릭터 수정</button></div>
				</td>
				<td colspan="3">
	...
	<form name="character" action="character_modify2_ok.php" method="post">
		<input type="hidden" name="id" value= <?php echo $id ?>>
		<input type="hidden" name="oldcharactername" id="oldcharactername" value="<?php echo $row['charactername']?>">
	...
	<form name="add_cancel_" action="character_modify.php" method="post">
	<input type="hidden" name="id" value= <?php echo $id ?>>
	</form>
